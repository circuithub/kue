...
exports.createQueue = function(){
  if (Queue.singleton == null) {return Queue.singleton = new Queue;}
  else {return Queue.singleton}
};
...
Queue.prototype.search = function(searchTerms, fn){
  reds.createClient = this.client;
  search = reds.createSearch('q:search');
  search.query(searchTerms).end(fn);
};
